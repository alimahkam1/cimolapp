...
def select_talent_from_pool(dynamic_response: str, talent_pool_df: pd.DataFrame) -> str:
    ...
    prompt = (
        ...
        f"{talent_pool_text}\n\n"
        "Berdasarkan rekomendasi di atas, pilihlah talent yang sesuai dengan peran yang direkomendasikan dan jumlah yang dibutuhkan. Keep in mind that the talent that is being choosen shouldn't already been assigned (we can check this from the assignment status column), this is a must!"
